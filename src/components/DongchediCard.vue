<template>
  <div class="single-rank-card dongchedi-card">
    <div class="card-header">
      <span class="card-icon">🚗</span>
      <h3 class="card-title">懂车帝热搜</h3>
...
const loadData = async () => {
  loading.value = true
  try {
    const response = await fetch(`${API_BASE}/v2/dongchedi?encoding=json`)
